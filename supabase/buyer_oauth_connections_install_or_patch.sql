-- Nexus buyer OAuth install/patch.
-- Run this in the Supabase SQL editor before deploying the updated functions.
-- The OAuth callback remains the existing oauth-connections URL, so the Google
-- Cloud redirect URI does not change.
...
alter table public.buyer_oauth_connection_states

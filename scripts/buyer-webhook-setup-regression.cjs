...
for (const [source, marker, label] of [
  ...
  [buyerPage, "Confirm inbound connection", "inbound confirmation control"],
  [buyerPage, "Save and send test", "outbound test control"],
  [buyerPage, "Tests validate the connection and mapping without starting a paid workflow", "test-mode buyer disclosure"],
  [buyerPage, "Activate live requests", "explicit activation control"],
  [buyerPage, "Webhook request usage", "buyer usage display"],
